...
Mobile.setText(findTestObject('Object Repository/login/input username'), 'cicicaca13', 0)

Mobile.tap(findTestObject('Object Repository/login/password tap'), 0)

Mobile.setText(findTestObject('Object Repository/login/input password'), 'Cintilucu13', 0)
